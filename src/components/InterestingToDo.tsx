...
const InterestingToDO: React.FC = () => {
  return (
    <section id="interesting">
      <h2>Interesting to do</h2>
      <p>
        Iceland is a beautiful country, with unique landscapes and very intersting history. The wedding willt ake place in Akrane, very small town, but here are a few things you can do in the area: (use Google translage):
